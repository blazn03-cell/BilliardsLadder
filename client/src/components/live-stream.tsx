  ...
  const createStreamMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Your live stream has been added to the BilliardsLadder network!",
        duration: 5000,
      });
      setOpen(false);
      form.reset();
        ...
        <Card className="bg-card/30 border-emerald-500/20">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-400 mb-6">
              Be the first to start streaming on the BilliardsLadder network!
            </p>
            <CreateStreamDialog />
          </CardContent>
        </Card>
