              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    {rookieOfWeek.rookieWins || 0} wins • {rookieOfWeek.city}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-900/30 to-green-900/30 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">
                    Rating: {mostImproved.rating} • {mostImproved.city}
                  </div>
                </div>
              </div>
            </div>
...
function RookieGraduationCard({ players }: { players: Player[] }) {
  ...
  const readyToGraduate = players.filter(
    p => p.isRookie && (p.rating >= 500 || (p.rookieWins || 0) >= 10)
  );
    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto">
          Your safe space to learn, grow, and earn respect before stepping into the main match play.
          ...
          <CardContent className="text-center py-12">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 max-w-md mx-auto">
                The Rookie Section is your launching pad. Start here, learn the ropes, and graduate
                to the main ladder when you're ready to face the sharks.
              </p>
