...
const kellyPoolSchema = z.object({
  ...
  maxPlayers: z
    ...
    .max(15, "Max 15 players for Kelly Pool"),
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-400">
            {kellyPool.currentPlayers || 0} players • ${kellyPool.entry} each •
            {kellyPool.table || "TBD"}
          </div>
          ...
          {kellyPool.status === "completed" && (
            <div className="text-center text-gray-400">Game Completed</div>
          )}
        </div>
      </CardContent>
    </Card>
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-start space-x-2">
            ...
            <span className="text-gray-300">
              Each player draws a numbered pill secretly - that's your target
              ball
            </span>
          </div>
          <div className="flex items-start space-x-2">
          ...
          <div className="flex items-start space-x-2">
            <span className="text-orange-400 font-bold">•</span>
            <span className="text-gray-300">
              Fast-paced game perfect for quick match play between ladder
              matches
            </span>
          </div>
          <div className="flex items-start space-x-2">
