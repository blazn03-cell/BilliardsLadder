...
import LeagueProgressionPage from "@/pages/LeagueProgressionPage";
...
function AppContent({ activeTab }: { activeTab: string }) {
  ...
  const protectedTabs = [
    ...
    'organizer-hub', 'event-page', 'league-progression', 'recurring-leagues', 'profile-settings',
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {activeTab === "player-dashboard" && <PlayerDashboard />}
        {activeTab === "player-subscription" && <PlayerSubscription />}
        {activeTab === "ladder" && <LadderPage tableType="9ft" />}
        {activeTab === "barbox-ladder" && <LadderPage tableType="barbox" />}
        {activeTab === "eightfoot-ladder" && <LadderPage tableType="8ft" />}
        ...
        {activeTab === "organizer-hub" && <OrganizerHub />}
        {activeTab === "event-page" && <TournamentEventPage />}
        {activeTab === "league-progression" && <LeagueProgressionPage />}
        {activeTab === "recurring-leagues" && <RecurringLeagues />}
        {activeTab === "profile-settings" && <ProfileSettings />}
        {activeTab === "player-threshold" && <ThresholdDashboard />}
  ...
  const navigationGroups = [
    {
      ...
      icon: Trophy,
      items: [
        { id: "dashboard", label: "🎯 My Dashboard", requiresAuth: true },
        { id: "profile-settings", label: "⚙️ Profile & Privacy", requiresAuth: true },
        // Ladders Section
        ...
        { id: "organizer-hub",       label: "🎛️ Organizer Hub",         requiresAuth: true },
        { id: "event-page",          label: "🎟️ Event Page",            requiresAuth: true },
        { id: "league-progression",  label: "⬆️ League Progression",    requiresAuth: true },
        { id: "recurring-leagues",   label: "🔁 Recurring Leagues",     requiresAuth: true },
      ]
    },
    {
      id: "media",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "player-threshold", label: "📊 My Threshold & Rewards", requiresAuth: true },
        ...
        <footer className="relative z-10 bg-black/80 border-t border-neon-green/20 py-8 mt-16">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center items-center space-x-6 text-sm text-gray-400">
              ...
              <span>© 2025 BilliardsLadder</span>
              <span className="text-neon-green">•</span>
