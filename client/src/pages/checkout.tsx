  ...
  const getPaymentInsightsMutation = useMutation({
    mutationFn: () =>
      fetch('/api/ai/community-chat', {
        ...
        body: JSON.stringify({ 
          question: `Analyze this payment: ${paymentInfo.description} for $${paymentInfo.amount}. Provide insights about value, competitive analysis, and strategic recommendations for this type of investment in the BilliardsLadder billiards community.` 
        })
      }).then(res => res.json()),
    onSuccess: (data) => {
