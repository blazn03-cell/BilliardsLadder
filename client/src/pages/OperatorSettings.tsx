  ...
  return (
    <div className="container mx-auto px-4 py-8" data-testid="operator-settings">
      <div className="mb-8">
        ...
        <p className="text-gray-300">Customize your BilliardsLadder instance for your city and area</p>
      </div>
      ...
      <div className="grid gap-6 max-w-4xl">
        ...
        <Card className="bg-black/60 border-green-600/30">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">
              Set your city and area to personalize the BilliardsLadder experience
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-400">
                This will customize the branding throughout your BilliardsLadder instance.
                For example: "{cityName || "Your City"} {areaName || "Your Area"} BilliardsLadder"
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-black/60 border-green-600/30">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-400">
                This text will appear in select locations throughout your BilliardsLadder instance for additional branding.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="bg-black/40 rounded-lg p-4 border border-green-600/20">
              <h3 className="text-xl font-bold text-green-400 mb-2">
                {cityName || "Your City"} {areaName || "Your Area"} BilliardsLadder
              </h3>
              ...
              <div className="mt-4 p-2 bg-green-900/20 rounded text-xs text-green-300">
                💡 This preview shows how your branding will appear throughout the BilliardsLadder platform
              </div>
            </div>
          </CardContent>
        </Card>
