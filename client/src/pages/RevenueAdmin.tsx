...
const revenueConfigSchema = z.object({
  ...
  splitPercentages: z.object({
    billiardsLadder: z.number().min(0).max(100),
    operator: z.number().min(0).max(100),
    seasonPot: z.number().min(0).max(100),
    monthlyOperations: z.number().min(0).max(100),
  }).refine(
    (data) => data.billiardsLadder + data.operator + data.seasonPot + data.monthlyOperations === 100,
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-white font-medium">{currentConfig.config.splitPercentages.billiardsLadder}%</span>
                        </div>
                        <div className="flex justify-between">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        type="number"
                        {...form.register('splitPercentages.billiardsLadder', { valueAsNumber: true })}
                        className="bg-gray-800 border-gray-600 text-white"
                        min="0"
                        max="100"
                      />
                  ...
                  <div className="text-sm text-gray-400">
                    Total: {
                      (form.watch('splitPercentages.billiardsLadder') || 0) +
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <div className="text-white">
                            {config.splitPercentages.billiardsLadder}% / {config.splitPercentages.operator}% / {config.splitPercentages.seasonPot}% / {config.splitPercentages.monthlyOperations}%
                          </div>
                        </div>
                        <div>
