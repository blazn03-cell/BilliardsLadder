...
const SECTIONS: Section[] = [
  {
    ...
    rows: [
      ...
      { name: "Assassin", sub: "10-WIN STREAK", col2: "Streak title", howTo: "Win 10 stake matches in a row. Rare. The Wall feed alerts players across the platform.", status: "live" },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: "First Break", col2: "Opening shift", howTo: "Win 10+ matches where you're one of the first 3 players to check in at your hall that day. Adapts to each hall's actual opening hours. Rewards opening-shift regulars and drives consistent early traffic for partner halls. Pairs with Night Owl as the bookend badges of the day.", status: "proposed" },
  ...
  },
  {
    ...
    rows: [
      { name: "Monthly Tournament", col2: "$500 added", howTo: "Pay entry fee ($40 Rookie / $30 Basic / $20 Premium / Free–$20 Elite). Place in the prize positions. NOTE: Free tier was removed in upgrade — pricing/access flow needs re-confirmation.", status: "hold" },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: "The Callout", col2: "Earned · 7D streak", howTo: "Earned via 7-day match-completion streak. Active for 7 days. Publicly call out any player on the ladder to a stake match. Their name appears on the public Callout Wall in the app with your challenge. They have 72 hours to accept or take a -10 rank penalty + 'REFUSED [your name]' marker on their profile for 7 days. Win the callout: +25 rank points + Caller status on the Wall for 7 days + The Roast graphic auto-generated. Lose: -15 rank points + opponent earns 'Defender' badge for 7 days. Single callout per earning cycle.", status: "proposed" },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      ...
      { name: "Friend Leaderboard", col2: "Private", howTo: "Add friends from your hall or region. Private leaderboard tracks H2H stats between you and your friends only.", status: "live" },
      { name: "Ladder Leaderboard", col2: "Public", howTo: "Default ranking. Win matches — climb the ladder leaderboard.", status: "live" },
