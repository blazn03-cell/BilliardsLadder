...
export default function RookieSection() {
  ...
  const createRookieEvent = (type: string) => {
    const eventData = {
      name: type === "tournament" ? "Rookie Mini-Tournament" : "Break & Run Bonus",
      type,
      buyIn: 6000, // $60
      maxPlayers: 8,
      ...
      description: type === "tournament" 
        ...
        : "Make a break and run to win the bonus prize (max $50)",
    };
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="bg-felt-darker border border-neon-green/30">
                <CardHeader>
                  ...
                  <CardDescription>Mini-tournaments and bonus events for rookies only</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <Button
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="text-center p-4 bg-black/20 rounded-lg border border-neon-green/20">
                    ...
                    <p className="text-sm text-gray-400">Access to subscriber-only bonus events</p>
                  </div>
                </div>
                <div className="text-center">
                  <Button
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-green-600/20 border border-green-500/30 rounded-lg">
                  ...
                  <p className="text-sm text-gray-300">
                    Earn 100 Rookie Points to automatically graduate to the main BilliardsLadder. 
