...
export class ICalService {
  ...
  private generateICalFromChallenges(challenges: Challenge[]): string {
    ...
    challenges.forEach(challenge => {
      ...
      // Add custom properties for BilliardsLadder using description field
  ...
  private formatChallengeDescription(challenge: Challenge): string {
    let description = `BilliardsLadder Professional Billiards League\n\n`;
  ...
  /**
   * Map BilliardsLadder status to iCal status
   */
