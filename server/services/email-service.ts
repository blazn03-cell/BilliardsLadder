...
class EmailService {
  ...
  async sendEmail(options: EmailOptions): Promise<void> {
    try {
      const mailOptions = {
        from: options.from || '"Billiards Ladder" <noreply@billiardsladder.net>',
        to: options.to,
  ...
  generatePayoutEmail(data: PayoutEmailData): string {
    ...
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <div class="logo">🎱 BILLIARDS LADDER</div>
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <a href="https://billiardsladder.net/app" style="background-color: #00ff00; color: #000000; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
          ...
          <div class="footer">
            ...
            <p>Questions? Contact support@billiardsladder.net</p>
          </div>
        </div>
      </body>
      </html>
      ...
      <body>
        <div class="container">
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <a href="https://billiardsladder.net/app?tab=escrow-challenges" style="background-color: #00ff00; color: #000000; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
              VIEW MY MATCHES 🎯
            </a>
          </div>
          <div class="footer">
  ...
  async sendPasswordResetEmail(
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #065f46 0%, #047857 100%); color: white; padding: 20px; text-align: center;">
          <h1 style="margin: 0;">BilliardsLadder</h1>
        ...
        <div style="padding: 30px; background: #f9fafb;">
          ...
          <p style="color: #6b7280; font-size: 16px; line-height: 1.6; margin-bottom: 25px;">
            We received a request to reset your password for your BilliardsLadder account. 
        ...
        <div style="background: #374151; color: #9ca3af; padding: 20px; text-align: center; font-size: 12px;">
          <p style="margin: 0;">© 2025 BilliardsLadder - In here, respect is earned in racks, not words</p>
        </div>
      </div>
    `;
    ...
    try {
      await this.sendEmail({
        to: email,
        subject: "BilliardsLadder - Password Reset Request",
        html,
      });
      return true;
    } catch (error) {
