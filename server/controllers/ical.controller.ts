...
export function getPublicFeed(storage: IStorage) {
  return async (req: Request, res: Response) => {
    try {
      ...
      res.setHeader('Content-Disposition', 'inline; filename="billiardsladder-public.ics"');
...
export function getPlayerFeed(storage: IStorage) {
  return async (req: Request, res: Response) => {
    try {
      ...
      res.setHeader('Content-Type', 'text/calendar; charset=utf-8');
      res.setHeader('Content-Disposition', `inline; filename="billiardsladder-${player}.ics"`);
...
export function getHallFeed(storage: IStorage) {
  return async (req: Request, res: Response) => {
    try {
      ...
      res.setHeader('Content-Type', 'text/calendar; charset=utf-8');
      res.setHeader('Content-Disposition', `inline; filename="billiardsladder-hall-${hallId}.ics"`);
...
export function getUpcomingFeed(storage: IStorage) {
  return async (req: Request, res: Response) => {
    try {
      ...
      res.setHeader('Content-Type', 'text/calendar; charset=utf-8');
      res.setHeader('Content-Disposition', `inline; filename="billiardsladder-upcoming-${playerId}.ics"`);
...
export function getCalendarInfo(req: Request, res: Response) {
  res.json({
    name: 'BilliardsLadder Challenge Calendar',
