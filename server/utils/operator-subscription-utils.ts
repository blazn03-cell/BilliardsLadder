...
// NOTE: Pool hall owners (operators) do not pay a subscription fee.
// Access to the platform is FREE for all operator tiers.
// Operators earn a revenue share on match service fees instead of paying monthly.

export interface SubscriptionTier {
  name: string;
  maxPlayers: number;
  basePriceMonthly: number; // in cents (0 = free)
  description: string;
}
...
export const SUBSCRIPTION_TIERS: Record<string, SubscriptionTier> = {
  small: {
    name: "Small Hall",
    maxPlayers: 15,
    basePriceMonthly: 0, // Free for pool hall owners
