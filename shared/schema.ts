...
export const users = pgTable("users", {
  ...
  emailHidden: boolean("email_hidden").default(true), // Hide email from other players by default
  nickname: text("nickname"), // Display name shown publicly instead of real name (optional)
...
export const players = pgTable("players", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  name: text("name").notNull(),
  nickname: text("nickname"), // Optional display alias shown on leaderboard instead of real name
...
export const tournaments = pgTable("tournaments", {
  ...
  addedMoney: integer("added_money").default(0), // BilliardsLadder added money in cents
...
export const challengeCommissions = pgTable("challenge_commissions", {
  ...
  billiardsLadderShare: integer("billiards_ladder_share").notNull(), // Platform cut in cents
...
export const revenueSplits = pgTable("revenue_splits", {
  ...
  billiardsLadderShare: integer("billiards_ladder_share").notNull(), // Platform cut
...
export const operatorTiers = pgTable("operator_tiers", {
  ...
  revenueSplitPercent: integer("revenue_split_percent").notNull(), // Percentage to Billiards Ladder (5 or 10)
...
export const payoutDistributions = pgTable("payout_distributions", {
  ...
  platformFee: integer("platform_fee").notNull(), // Billiards Ladder's cut
